module.exports = {
  'Demo test GM' : function (browser) {
    ...
    .assert.elementPresent('#development')
    .assert.elementPresent('#agile')
    .assert.elementNotPresent('#test')
    .assert.elementNotPresent('#management')
    .assert.elementNotPresent('#backend')
    .assert.elementNotPresent('#frontend')
      .end();
  }
};
